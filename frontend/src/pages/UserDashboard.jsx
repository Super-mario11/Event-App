                      ...
                      <div className="flex-1 space-y-3">
                        ...
                        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 text-sm">
                          <div>
                            ...
                            <div className="font-medium text-gray-900">{ticket.ticketType}</div>
                          </div>
                          <div>
                            <div className="text-gray-500">Quantity</div>
                            <div className="font-medium text-gray-900">{ticket.quantity}</div>
                          </div>
                          <div>
                            <div className="text-gray-500">Total Paid</div>
                            <div className="font-medium text-gray-900">${ticket.totalPaid}</div>
                          </div>
                          <div>
